        ...
        if (data['arquivo_limpo'] == 1) {
            ...
            if ($("#checkbox_veiculos").is(':checked')) {
                ...
                if (data['dadosVeiculos'] != 0) {
                    ...
                    htmlAlertVeiculo += '<div class="ui  floating red message" id="TransitomessageVeiculos"><p style="margin: 0 !important;padding: 0 !important;">Veículo não cadastrado ou não identificado</p><div>';
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (response) {
                            Swal.fire({
                                title: 'Transito autorizado!',
                                text: "O transito foi autorizado com sucesso.",
                                type: 'success',
