...
var syscancela_seu_cartao_nao_esta_cadastrado = new Audio('/audio/syscancela-seu-cartao-nao-esta-cadastrado.mp3');
...
$(document).ready(function () {
    ...
    emitirCondutorNaoCadastrado();
    setInterval(emitirCondutorNaoCadastrado, 1000);
...
function emitirMensagem() {
    $.getJSON('/admin/transitos/ver/emitir-som-mEntrada', function (data) {
        var d = new Date;
...
function emitirCondutorNaoCadastrado() {
    $.getJSON('/admin/transitos/ver/emitir-som-errEntrada', function (data) {
        if (data == 1 || data == '1') {
            syscancela_seu_cartao_nao_esta_cadastrado.play();
        }
    });
}
//Funao para emitir som
function emitirSons() {
