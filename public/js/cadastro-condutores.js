        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length != 0) {
                    ...
                    $('#curso_id').val(data[0].curso_id)
                    $('#pessoa_tipo_id').val(data[0].pessoa_tipo_id)
...
$("#cadastro_condutor").submit(function (e) {
    ...
    var qCardsSubmit = $("#veiculos .classVeiculos").length;
    ...
    //verficando se na ficha de cadastro do condutor tem pelo menos 1 veiculo.
    if (qCardsSubmit < 1) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (Object.keys(data) == 'sucesso') {
                    ...
                    setTimeout(function () {
                        location.reload('/admin/cadastro/condutor/cadastrar/validacao/form');
                    }, 1000);
