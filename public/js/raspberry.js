...
$(document).ready(function () {
  ...
  listarRaspBerry();
  $('#identificacao').mask('0ZZ.0ZZ.0ZZ.0ZZ', {
    translation: {
      'Z': {
  ...
  $('#identificacao').mask('099.099.099.099');
...
function adicionarRaspberry(id) {
  ...
  $("#formulario_rasp  #nomeRasp, #identificacao ").each(function () {
...
function statusRaspBerry(id) {
  ...
  $.ajax({
    ...
    success: function (data) {
      $('#nomeRasp').val(data.nome);
      $('#identificacao_view').val(data.ip);
      $('#tipo_rasp_view').val(data.nome_tipo_rasp);
      $('#data_de_criacao').val(moment(data.data_de_criacao).format('LL'));
      $('#data_atualizacao').val(moment(data.ultima_atualizacao).format('LL'));
      $("#formulario_rasp  #data_de_criacao, #data_atualizacao, #nomeRasp, #identificacao_view, #tipo_rasp_view ").each(function () {
        $(this).attr("readonly", true);
        $(this).attr("disabled", true);
