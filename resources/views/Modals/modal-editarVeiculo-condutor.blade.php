<div class="ui large modal" id="modalEditarVeiculos">
    <i class="close icon"></i>
    <div class="header">
        <h2 class="textoTopoOuvidoria" style="color: #006944;"><i class="plus square icon"></i>&nbsp;Editar
            veículo</h2>
    </div>
    
    <div class="content">
        <form class="ui form" id="formulario_veiculos_edit">
            <input type="hidden" id="idVeiculoCondutor" name="idVeiculoCondutor" value="">
            {{ csrf_field()}}
            {{method_field('POST')}}
            <div class="ui three column doubling stackable grid">
                                    ...
                                    <div class="content">
                                        <div class="center">
                                            <div class="ui inverted button btn-file">
                                                ...
                                                <input type="file" id="upload_imagem_veiculo_edit" name="uploaded_file">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" value="" name="nomeimg" id="nomeimg">

                                <img src="" id="imagem_veiculoEdit" name="imagem_veiculoEdit" style="border-radius: 0% !important;">
                            </div>
                        </div>
                    </div>
                ...
                <div class="column">
                    <div class="field inputsFormVeiculo" id="d_tipo_veiculo">
                        <label>Veiculo:</label>
                        <div class="tipo_veiculo ui fluid selection dropdown ">
                            <input type="hidden" id="tipo_veiculo_edit" name="tipo_veiculo_edit" />
                    ...
                    <div class="field inputsFormVeiculo" id="d_modelo">
                        <label>Modelo:</label>
                        <input type="text" name="modelo_edit" id="modelo_edit">
                        <span id="msg_erros" class="modelo"></span>
                    </div>
                    <div class="field inputsFormVeiculo" id="d_cor">
                        <label>Cor:</label>
                        <div class="ui fluid search selection dropdown cor_edit">
                            <input type="hidden" name="cor_edit" id="cor_edit" />
                            <i class="dropdown icon"></i>
                            <div class="default text">Selecione a cor:</div>
                            <div class="menu">
                ...
                <div class="column">
                    <div class="field inputsFormVeiculo" id="d_placa">
                        <label>Placa:</label>
                        <input type="text" name="placa_edit" id="placa_edit">
                        <span id="msg_erros" class="placa"></span>
                    </div>
                    <div class="field inputsFormVeiculo" id="d_marca">
                            <label>Marca:</label>
                            <div class="ui fluid search selection dropdown marca_edit">
                                <input type="hidden" name="marca_edit" id="marca_edit" />
                                <i class="dropdown icon"></i>
                    ...
                    <div class="field inputsFormVeiculo" id="d_ano">
                        <label>Ano:</label>
                        <input type="text" name="ano_edit" id="ano_edit" min="4" max="5" placeholder="Ano">
    ...
    <div class="actions">
        ...
        <button id="salvar_modalVeiculoEdit" type="button" class="ui right button"
